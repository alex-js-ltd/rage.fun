	...
	return (
		<div className="scrollbar-hide flex h-full w-full items-center overflow-x-scroll">
			...
			>
				{({ isActive }) => (
					<div className="relative flex h-full w-fit items-center">
						<span className={cn('text-text-200 text-[15px] font-medium', sortType === 'createdAt' && 'text-white')}>
							Created At
						</span>
			...
			>
				{({ isActive }) => (
					<div className="relative flex h-full w-fit items-center">
						<span className={cn('text-text-200 text-[15px] font-medium', sortType === 'lastTrade' && 'text-white')}>
							Last Trade
						</span>
			...
			>
				{({ isActive }) => (
					<div className="relative flex h-full w-fit items-center">
						<span className={cn('text-text-200 text-[15px] font-medium', sortType === 'marketCap' && 'text-white')}>
							Market Cap
						</span>
