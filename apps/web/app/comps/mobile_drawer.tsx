...
import { DialogRoot, DialogContent, DialogTitle, DialogTrigger } from '@/app/comps/ui/dialog'
	...
	return (
		<DialogRoot modal={false} open={open} onOpenChange={onOpenChange}>
			...
			<DialogContent
				forceMount
				className="
fixed bottom-[0px] sm:bottom-0 w-full max-w-[598px] h-auto min-h-[381.5px] frost z-50 p-10
