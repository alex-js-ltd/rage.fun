...
export function IntervalPanel({ mint, searchParams }: { mint: string; searchParams: { [x: string]: string } }) {
	...
	return (
		<Form ref={formRef} action={`/token/${mint}`} replace>
			...
			<SelectPrimitive.Root
				value={interval}
				onValueChange={value => {
					// bind the value *before* submitting (no state race, no stale closure)
