...
export function getTokenLogoProps(token: {
  image: string;
  thumbhash: string;
  symbol: string;
}): ImageProps {
...
export const solLogoProps: ImageProps = {
  ...
  blurDataURL: createPngDataUri(
    Buffer.from([
      0x85, 0xe7, 0x09, 0x17, 0x04, 0x07, 0x98, 0x98, 0x77, 0x88, 0x77, 0x81,
      0x7c, 0x86, 0x77, 0x78, 0x87, 0x88, 0x7a, 0x9f, 0xe7, 0xfb, 0x73, 0x0f,
    ]).toString("base64"),
  ),
  sizes: "40px",
  placeholder: "blur",
